...
invariant(hashPattern.test(site.provenance?.source_appmanifest_sha256),
  "Invalid source appmanifest hash");
invariant(commitPattern.test(site.provenance?.renderer_upstream_commit),
  "Invalid renderer upstream commit");
invariant(commitPattern.test(site.provenance?.render_commit), "Invalid render commit");
invariant(commitPattern.test(site.provenance?.viewer_commit), "Invalid viewer commit");
invariant(hashPattern.test(site.provenance?.tree_render_manifest_sha256),
  "Invalid tree render manifest hash");
